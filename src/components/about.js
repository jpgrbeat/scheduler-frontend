...
const About =()=>{
  return(
    <React.Fragment>
      ...
      <p>
        I am hoping that over time I do not get completely ambushed by Chrome notifications. If you have any questions, email me  <span><a href="mailto:joshua.ross.miller@gmail.com">here</a></span>. The code base for this project is contained <span><a href="https://github.com/jpgrbeat/scheduler-frontend" target="_blank">here</a></span> and <span><a href="https://github.com/jpgrbeat/scheduler-backend" target="_blank">here</a></span>.
      </p>
    </React.Fragment>
  )
}
